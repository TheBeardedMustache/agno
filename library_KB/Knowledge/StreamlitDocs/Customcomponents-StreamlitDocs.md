...
[Previous: Connections and secrets](/develop/api-reference/connections)[Next: st.components.v1​.declare\_component](/develop/api-reference/custom-components/st.components.v1.declare_component)
