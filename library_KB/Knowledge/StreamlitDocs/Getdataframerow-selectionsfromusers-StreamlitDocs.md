...
[Previous: Annotate an Altair chart](/develop/tutorials/elements/annotate-an-altair-chart)[Next: Get dataframe row-selections (streamlit<1.35.0)](/develop/tutorials/elements/dataframe-row-selections-old)
