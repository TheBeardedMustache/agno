...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.46.0/lib/streamlit/elements/spinner.py#L37 "View st.spinner source code on GitHub") | |
| --- | --- |
...
[Previous: st.progress](/develop/api-reference/status/st.progress)[Next: st.status](/develop/api-reference/status/st.status)
