st.column\_config.ImageColumn - Streamlit Docs
...
st.column\_config.ImageColumn
-----------------------------

Streamlit VersionVersion 1.46.0Version 1.45.0Version 1.44.0Version 1.43.0Version 1.42.0Version 1.41.0Version 1.40.0Version 1.39.0Version 1.38.0Version 1.37.0Version 1.36.0Version 1.35.0Version 1.34.0Version 1.33.0Version 1.32.0Version 1.31.0Version 1.30.0Version 1.29.0Version 1.28.0Version 1.27.0Version 1.26.0Version 1.25.0Version 1.24.0Version 1.23.0Version 1.22.0Version 1.21.0Version 1.20.0

Configure an image column in st.dataframe or st.data\_editor.

The cell values need to be one of:

* A URL to fetch the image from. This can also be a relative URL of an image
  deployed via [static file serving](https://docs.streamlit.io/develop/concepts/configuration/serving-static-files).
...
column\_config parameter of st.dataframe or st.data\_editor.

| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.46.0/lib/streamlit/elements/lib/column_types.py#L1311 "View st.ImageColumn source code on GitHub") | |
| --- | --- |
| st.column\_config.ImageColumn(label=None, \*, width=None, help=None, pinned=None) | |
| Parameters | |
...
[Fullscreen *open\_in\_new*](https://doc-image-column.streamlit.app//?utm_medium=oembed&)

[Previous: Link column](/develop/api-reference/data/st.column_config/st.column_config.linkcolumn)[Next: Area chart column](/develop/api-reference/data/st.column_config/st.column_config.areachartcolumn)
