st.column\_config.AreaChartColumn - Streamlit Docs
...
st.column\_config.AreaChartColumn
---------------------------------
...
| Function signature[[source]](https://github.com/streamlit/streamlit/blob/1.46.0/lib/streamlit/elements/lib/column_types.py#L1214 "View st.AreaChartColumn source code on GitHub") | |
| --- | --- |
| st.column\_config.AreaChartColumn(label=None, \*, width=None, help=None, pinned=None, y\_min=None, y\_max=None) | |
| Parameters | |
...
[Previous: Image column](/develop/api-reference/data/st.column_config/st.column_config.imagecolumn)[Next: Line chart column](/develop/api-reference/data/st.column_config/st.column_config.linechartcolumn)
