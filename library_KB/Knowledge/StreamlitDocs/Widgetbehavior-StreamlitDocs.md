...
[Fullscreen *open\_in\_new*](https://doc-guide-widgets-form-callbacks.streamlit.app/?utm_medium=oembed)
...
A solution to [Retain statefulness when changing a widget's parameters](/develop/concepts/architecture/widget-behavior#retain-statefulness-when-changing-a-widgets-parameters) is provided further on.
...
The first method was shown above in [Save widget values in Session State to preserve them between pages](/develop/concepts/architecture/widget-behavior#save-widget-values-in-session-state-to-preserve-them-between-pages)
...
[Fullscreen *open\_in\_new*](https://doc-guide-widgets-change-parameters-solution.streamlit.app/?utm_medium=oembed)
...
[Previous: Fragments](/develop/concepts/architecture/fragments)[Next: Multipage apps](/develop/concepts/multipage-apps)
